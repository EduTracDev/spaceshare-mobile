...
export default function NumberOfGuests({
  ...
  const [finalAddOns, setFinalAddOns] = useState<{ [key: string]: number }>(selectedAddOns);
                ...
                {exceedsCapacity && !hasAttendeePricing && (
                  <View style={s.errorRow}>
                    ...
                    <Text style={s.errorText}>
                      Guest count exceeds the maximum capacity of {spaceCapacity} for this space.
                    </Text>
                  </View>
                )}
...
const s = StyleSheet.create({
  ...
  sheet: {
    ...
    paddingHorizontal: 16, paddingBottom: 48, height: height * 0.75,
  },
  handle: {
  ...
  dropdownList: { borderWidth: 1, borderColor: '#E4E7EC', borderRadius: 12, marginTop: 4, overflow: 'hidden' },
  dropdownItem: {

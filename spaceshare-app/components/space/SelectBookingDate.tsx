...
export default function SelectBookingDate({
  ...
  // Range selection: first tap = rangeStart, second tap = rangeEnd
...
const handleDayPress = (cell: DayCell) => {
  ...
  const startLabel = startSet ? timeLabelFrom(startH, startM, startP) : spaceOpenTime;
  const endLabel   = endSet   ? timeLabelFrom(endH, endM, endP)       : spaceCloseTime;
            ...
            <View style={s.timeRow}>
              ...
              <View style={s.timeCol}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => rangeStart && setPickingTime('end')}
                >
